...
class Config:
    ...
    ALLOW_MULTIPLE_SIGNALS_PER_CANDLE = os.getenv('ALLOW_MULTIPLE_SIGNALS_PER_CANDLE', 'false').lower() == 'true'
    ...
    TRAILING_STOP_PROFIT_THRESHOLD = _get_float_env('TRAILING_STOP_PROFIT_THRESHOLD', '0.5')
    TRAILING_STOP_DISTANCE_PIPS = _get_float_env('TRAILING_STOP_DISTANCE_PIPS', '0.5')
    
    DRY_RUN_TRAILING_STOP = os.getenv('DRY_RUN_TRAILING_STOP', 'false').lower() == 'true'
    
    TRAILING_STOP_MOVE_PIPS = _get_float_env('TRAILING_STOP_MOVE_PIPS', '0.5')
    TRAILING_STOP_TRAIL_DISTANCE_PIPS = _get_float_env('TRAILING_STOP_TRAIL_DISTANCE_PIPS', '0.5')
